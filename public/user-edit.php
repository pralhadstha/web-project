        ...
        <section class="content">
            <div class="col-md-9">
                <div class="box box-info">
                    ...
                    <form class="form-horizontal" action="user-edit.php" method="post">
                        <div class="box-body">
                            ...
                            <input type="hidden" value="<?php echo isset($userId) ? $userId : null ?>" name="userId" id="userId">
